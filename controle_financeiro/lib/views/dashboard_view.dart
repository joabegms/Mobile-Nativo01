                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Icon(Icons.arrow_downward, color: Colors.green[700], size: 28),
                              const SizedBox(height: 8),
                              const Text(
                                'Receitas',
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              Icon(Icons.arrow_upward, color: Colors.red[700], size: 28),
                              const SizedBox(height: 8),
                              const Text(
                                'Despesas',
                                style: TextStyle(fontSize: 12, color: Colors.grey),
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(builder: (_) => TransacoesListView()),
                          );
                        },
                  ...
                  if (transacaoVM.transacoes.isEmpty)
                    ...
                    ListView.builder(
                      ...
                      itemCount: transacaoVM.transacoes.length > 5 ? 5 : transacaoVM.transacoes.length,
                      itemBuilder: (context, index) {
                        final transacao = transacaoVM.transacoes[index];
                        return _buildTransacaoTile(context, transacao, transacaoVM);
                      },
                    ),
                ],
              ),
                ...
                TextButton(
                  onPressed: () {
                    transacaoVM.removerTransacao(
                      transacao.id,
                      usuarioId: Provider.of<AuthViewModel>(context, listen: false)
                          .usuarioLogado
                          ?.id,
                    );
